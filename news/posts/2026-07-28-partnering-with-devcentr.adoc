...
++++
<object class="diagram-svg" type="image/svg+xml" data="../assets/diagrams/toolchain-architecture.svg" width="720" height="420" style="aspect-ratio: 720 / 420" aria-label="Official entrypoint owns pin resolve, install, re-exec, and lifecycle">Official entrypoint owns pin resolve, install, re-exec, and lifecycle</object>
++++

.Sibling ownership
++++
<object class="diagram-svg" type="image/svg+xml" data="../assets/diagrams/sibling-ownership.svg" width="720" height="280" style="aspect-ratio: 720 / 280" aria-label="DevCentr lifecycle vs OpenShellOrg entrypoint dispatch">DevCentr lifecycle vs OpenShellOrg entrypoint dispatch</object>
++++
